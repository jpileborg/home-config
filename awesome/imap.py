...
password = imap_settings.password # your pw

mailbox = getattr(imap_settings, 'mailbox', 'INBOX') # inbox is default
...
mailserver = getattr(imap_settings, 'mailserver', '')
port = getattr(imap_settings, 'mailserverport', 993)
...
print
print 'Mail' 
print username.replace('@' + imap_settings.mailhost, '') + '\'s Mailbox'
